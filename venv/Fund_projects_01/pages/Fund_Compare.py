...
if filtered_nav.empty:
    ...
    fund_profiles = fund_profiles.loc[:, ["TH_CODE",'Classification Sector Scheme', "Fund Type", "Fund Company", "Geographic Focus", "Total Net Assets", "Current Initial Charge", "Current Annual Charge"]]
